...
import 'package:todo_auth_app/resource.dart';
...
class Todo {
  ...
  String assignment;
  bool isCompleted;
  DateTime time = DateTime.now(); // Automatically set the current time
  Todo({
    required this.title,
    required this.day,
...
class resource extends ChangeNotifier {
  String PresentWorkingUser = 'John Doe';
                ...
                children: [
                  ...
                  if (_selectedDay != null)
                    DropdownButtonFormField<String>(
                      ...
                      items:
                          dayAssignmentMap[_selectedDay!]!.map((assignment) {
            ...
            if (_controller.text.isNotEmpty &&
              ...
              try {
                final response = await http.post(
                  ...
                  body: {
                    'userid': Provider.of<resource>(context, listen: false)
                        .PresentWorkingUser,
                ...
                if (response.statusCode == 200) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('New Task Saved Succesfully....')),
                  );
                        ...
                        groupedByDay.entries.map((dayEntry) {
                          ...
                          return Card(
                            ...
                            child: ExpansionTile(
                              ...
                              children:
                                  assignments.entries.map((assignmentEntry) {
